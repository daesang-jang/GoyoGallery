...
export default function ArtistDetail_leejungyoung() {
 return (
      ...
      <main className="pt-32 pb-16 flex-1">
        <div className="max-w-4xl mx-auto px-6">
          <div className="mb-12">
            ...
            <div className="mb-8">
              <img src="/images/Exhibition/1/03.png" alt="이정용" className="w-full md:w-3/4 lg:w-2/4 mx-auto rounded-md mb-12" />
            </div>
